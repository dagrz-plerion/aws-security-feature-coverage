...
const SEED: { id: string; name: string; kind: DataSource["kind"]; aliases: string[] }[] = [
  ...
  { id: "dns-logs", name: "Route 53 Resolver DNS query logs", kind: "log", aliases: ["dns logs", "dns query logs", "resolver query logs", "route53 resolver dns query logs", "route 53 resolver dns query logs", "amazon route 53 resolver dns query logs"] },
  ...
  { id: "runtime-agent-ec2", name: "Runtime agent on EC2", kind: "agent", aliases: ["ec2 runtime monitoring", "guardduty agent for ec2", "runtime monitoring", "runtime activity"] },
